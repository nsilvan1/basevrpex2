...
emP = Tunnel.getInterface("vDrogas")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local pedlist = {}
...
Citizen.CreateThread(function()
	while true do
		local sleep = 1000
		if segundos > 0 then
			local distancia = GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()),GetEntityCoords(selectnpc),true)																																																																																	-- q6ERiL1haOYEuOwTypVU
