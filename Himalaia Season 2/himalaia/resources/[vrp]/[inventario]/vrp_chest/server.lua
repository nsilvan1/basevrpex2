...
local webhookbauitaliana = ""
local webhookbauplayboy = ""
...
local chest = {
	...
	["Native"] = { 5000,"native.permissao" },
	["Driftking"] = { 5000,"driftking.permissao" },
	["Bahamas"] = { 5000,"bahamas.permissao" },
	["LifeInvader"] = { 5000,"lifeinvader.permissao" },
	["Triade"] = { 5000,"triade.permissao" },
	["siciliana"] = { 5000,"siciliana.permissao" },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIÁVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
                    ...
                    if new_weight <= parseInt(chest[tostring(chestName)][1]) then
                        if actived[parseInt(user_id)] == 0 or not actived[parseInt(user_id)] then
                            if chestName == "Policia" then
									...
									if chestName == "Ballas" or chestName == "Vagos" or chestName == "Grove" or chestName == "Crips" or chestName == "Triade" or chestName == "Siciliana" or chestName == "Playboy" or chestName == "Native" or chestName == "Driftking" or chestName == "LifeInvader" or chestName == "Bloods" or chestName == "NineThree" then
									...
									if chestName == "Playboy" then					
									SendWebhookMessage(webhookbauplayboy,"```prolog\n[ID]: "..user_id.." "..identity.name.." "..identity.firstname.." \n[GUARDOU]: "..vRP.format(parseInt(amount)).." "..vRP.itemNameList(itemName).." \n[BAU]: "..chestName.." "..os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S").." \r```")
								end
                    ...
                    if items[itemName] ~= nil and parseInt(items[itemName].amount) >= parseInt(amount) then
                        if vRP.getInventoryWeight(parseInt(user_id))+vRP.getItemWeight(itemName)*parseInt(amount) <= vRP.getInventoryMaxWeight(parseInt(user_id)) then
                                    if chestName == "Policia" then
										...
										if chestName == "Ballas" or chestName == "Vagos" or chestName == "Grove" or chestName == "Crips" or chestName == "Triade" or chestName == "Italiana" or chestName == "Playboy" or chestName == "Natvie" or chestName == "Driftking" or chestName == "LifeInvader" or chestName == "Bloods" or chestName == "NineThree" then
										SendWebhookMessage(webhookbaugangues,"```prolog\n[ID]: "..user_id.." "..identity.name.." "..identity.firstname.." \n[RETIROU]: "..vRP.format(parseInt(amount)).." "..vRP.itemNameList(itemName).." \n[BAU]: "..chestName.." "..os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S").." \r```")
									end
										if chestName == "Ballas" then
										SendWebhookMessage(webhookbauballas,"```prolog\n[ID]: "..user_id.." "..identity.name.." "..identity.firstname.." \n[RETIROU]: "..vRP.format(parseInt(amount)).." "..vRP.itemNameList(itemName).." \n[BAU]: "..chestName.." "..os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S").." \r```")
										...
										if chestName == "Italiana" then					
										SendWebhookMessage(webhookbauitaliana,"```prolog\n[ID]: "..user_id.." "..identity.name.." "..identity.firstname.." \n[RETIROU]: "..vRP.format(parseInt(amount)).." "..vRP.itemNameList(itemName).." \n[BAU]: "..chestName.." "..os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S").." \r```")
									end
										if chestName == "Triade" then					
										SendWebhookMessage(webhookbauTriade,"```prolog\n[ID]: "..user_id.." "..identity.name.." "..identity.firstname.." \n[RETIROU]: "..vRP.format(parseInt(amount)).." "..vRP.itemNameList(itemName).." \n[BAU]: "..chestName.." "..os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S").." \r```")
									end
