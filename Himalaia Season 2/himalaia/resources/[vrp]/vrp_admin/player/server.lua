...
-----------------------------------------------------------------------------------------------------------------------------------------
Psrc = {}
Tunnel.bindInterface("vrp_player",Psrc)
-----------------------------------------------------------------------------------------------------------------------------------------
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookgarmas = ""
...
function src.checkVIP()
	...
	if user_id then
		if vRP.hasPermission(user_id,"vip.permissao") or vRP.hasPermission(user_id,"ceo.permissao") then
			return true
		else
			TriggerClientEvent("Notify",source,"negado","Você não possui <b>Vip</b> para fazer essa ação.") 
			return false
		end
	end
end
...
function src.checkAttachs()
	...
	local user_id = vRP.getUserId(source)
	if user_id then
		if vRP.getInventoryItemAmount(user_id,"compattach") >= 1 or vRP.hasPermission(user_id,"booster.permissao") or vRP.hasPermission(user_id,"vip.permissao") or vRP.hasPermission(user_id,"ceo.permissao") then
			return true
		else
...
function src.checkRoupas()
	...
	local user_id = vRP.getUserId(source)
	if user_id then
		if vRP.getInventoryItemAmount(user_id,"roupas") >= 1 or vRP.hasPermission(user_id,"vip.permissao") or vRP.hasPermission(user_id,"ceo.permissao") then
			return true 
		else
...
-----------------------------------------------------------------------------------------------------------------------------------------
local itemlist = {
	["m-armacaotec"] = { index = "m-armacaotec", nome = "M-Munição de Tec" },
	["m-armacaoak"] = { index = "m-armacaoak", nome = "M-Munição de Ak" },
	["m-armacaomp5"] = { index = "m-armacaomp5", nome = "M-Munição de Mp5" },
	["m-armacaog3"] = { index = "m-armacaog3", nome = "M-Munição de G3" },
	...
	["capsulas"] = { index = "capsulas", nome = "Cápsula" },
	["polvora"] = { index = "polvora", nome = "Pólvora" },
	["detergenteneutro"] = { index = "detergenteneutro", nome = "Detergente Neutro" },
	["bicarbonatodesodio"] = { index = "bicarbonatodesodio", nome = "Bicarbonato de Sódio" },
	["la"] = { index = "la", nome = "La" },
	["landesfiada"] = { index = "landesfiada", nome = "La Desfiada" },
	["agua"] = { index = "agua", nome = "Água" },
	["vinagre"] = { index = "vinagre", nome = "Vinagre" },
	["alvejantecaseiro"] = { index = "alvejantecaseiro", nome = "Alvejante Caseiro" },
	["alvejantepremium"] = { index = "alvejantepremium", nome = "Alvejante Premium" },
	...
	["lancaperfume"] = { index = "lancaperfume", nome = "LançaPerfume" },
	...
	["armacaodeg3"] = { index = "armacaodeg3", nome = "Armação de G3" },
	["armacaodemp5"] = { index = "armacaodemp5", nome = "Armação de Mp5" },
	["armacaodetec"] = { index = "armacaodetec", nome = "Armação de Tec" },
	...
	["wbody|WEAPON_PUMPSHOTGUN"] = { index = "remington", nome = "Remington" },
	...
	["wbody|WEAPON_SMG"] = { index = "mp5mk2", nome = "MP5" },
	...
	["wammo|WEAPON_PUMPSHOTGUN"] = { index = "m-remington", nome = "M.Remington" },
	...
	["wammo|WEAPON_SMG"] = { index = "m-mp5mk2", nome = "M.MP5" }
...
-----------------------------------------------------------------------------------------------------------------------------------------
local salarios = {
	{ ['permissao'] = "rental.permissao", ['nome'] = "Rental", ['payment'] = 1500 },
	{ ['permissao'] = "servidor.permissao", ['nome'] = "Servidor", ['payment'] = 2500 },
    { ['permissao'] = "elite.permissao", ['nome'] = "Elite", ['payment'] = 4500 },
	{ ['permissao'] = "ultimate.permissao", ['nome'] = "Ultimate", ['payment'] = 6500 },
	
	
	{ ['permissao'] = "policia.permissao", ['nome'] = "POLICIA", ['payment'] = 5000 },
	{ ['permissao'] = "toogle2.permissao", ['nome'] = "POLICIA", ['payment'] = 2500 },
	{ ['permissao'] = "paramedico.permissao", ['nome'] = "PARAMEDICO", ['payment'] = 5000 },
	{ ['permissao'] = "mecanico.permissao", ['nome'] = "MECANICO", ['payment'] = 1000 },
...
AddEventHandler("kickAFK",function()
    local source = source
    local user_id = vRP.getUserId(source)
    if not vRP.hasPermission(user_id,"admin.permissao") and not vRP.hasPermission(user_id,"admin.permissao") and not vRP.hasPermission(user_id,"mod.permissao") and not vRP.hasPermission(user_id,"suporte.permissao") then
...
RegisterCommand('mec',function(source,args,rawCommand)
	if args[1] then
		...
		if vRP.hasPermission(user_id,"mecanico.permissao") or vRP.hasPermission(user_id,"suporte.permissao") then
			if user_id then
				TriggerClientEvent('chatMessage',-1,"VLSC | "..identity.name.." "..identity.firstname.." ("..user_id..") ",{255,128,0},rawCommand:sub(4))
			end
		end
	end
end)
...
RegisterCommand('staff',function(source,args,rawCommand)
	if args[1] then
		...
		if vRP.hasPermission(user_id,"suporte.permissao") then
			if user_id then
				TriggerClientEvent('chatMessage',-1,"Staff",{255,56,56},rawCommand:sub(6))
			end
		end
	end
end)
