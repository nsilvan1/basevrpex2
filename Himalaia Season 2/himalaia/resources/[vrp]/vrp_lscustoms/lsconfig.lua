...
LSC_Config.prices = {
	...
	xenoncolor = {
		{ name = "White", xenon = 0, price = 10000 },
		{ name = "Blue", xenon = 1, price = 10000 },
		{ name = "Electric Blue", xenon = 2, price = 10000 },
		{ name = "Mint Green", xenon = 3, price = 10000 },
		{ name = "Lime Green", xenon = 4, price = 10000 },
		{ name = "Yellow", xenon = 5, price = 10000 },
		{ name = "Golden Shower", xenon = 6, price = 10000 },
		{ name = "Orange", xenon = 7, price = 10000 },
		{ name = "Red", xenon = 8, price = 10000 },
		{ name = "Pony Pink", xenon = 9, price = 10000 },
		{ name = "Hot Pink",xenon = 10, price = 10000 },
		{ name = "Purple", xenon = 11, price = 10000 },
		{ name = "Blacklight", xenon = 12, price = 10000 }
	},
	plates = {
	...
	wheelaccessories = {
		{ name = "Pneu Normal", price = 1200 },
		{ name = "Adesivos no Pneu", price = 1700 },
		--{ name = "Bulletproof Tires", price = 10000 },
		{ name = "Fumaça do Pneu Branca", smokecolor = {254,254,254}, price = 2700 },
		{ name = "Fumaça do Pneu Preta", smokecolor = {1,1,1}, price = 2700 },
		{ name = "Fumaça do Pneu Azul", smokecolor = {0,150,255}, price = 2700 },
		{ name = "Fumaça do Pneu Amarela", smokecolor = {255,255,50}, price = 2700 },
		{ name = "Fumaça do Pneu Laranja", smokecolor = {255,153,51}, price = 2700 },
		{ name = "Fumaça do Pneu Vermelha", smokecolor = {255,10,10}, price = 2700 },
		{ name = "Fumaça do Pneu Verde", smokecolor = {10,255,10}, price = 2700 },
		{ name = "Fumaça do Pneu Roxa", smokecolor = {153,10,153}, price = 2700 },
		{ name = "Fumaça do Pneu Rosa", smokecolor = {255,102,178}, price = 2700 },
		{ name = "Fumaça do Pneu Cinza",smokecolor = {128,128,128}, price = 2700 }
	},
	wheelcolor = {
		colors = colors,
		price = 700
	...
	offroadwheels = {
		...
		{ name = "Mudslinger", wtype = 4, modtype = 23, type = 4, mod = 1, price = 7200 },
